"""
Tests for the UnitaryLinearOperator class.
"""
import pytest
import torch
...
class TestUnitaryLinearOperator:
    """Test cases for the UnitaryLinearOperator class."""
    
    def test_abstract_class_instantiation(self):
        """Test that UnitaryLinearOperator cannot be instantiated directly (abstract class)."""
    ...
    def test_concrete_subclass_implementation(self, sample_tensor_2d):
        ...
        class RotationMatrixOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_unitary_property(self, sample_tensor_2d):
        ...
        class IdentityUnitaryOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
        ...
        class HadamardUnitaryOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_real_unitary_matrix(self, sample_tensor_2d):
        ...
        class OrthogonalOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_complex_unitary_matrix(self, sample_complex_tensor):
        ...
        class ComplexUnitaryOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_inheritance_from_linear_operator(self, sample_tensor_2d):
        """Test that UnitaryLinearOperator inherits correctly from LinearOperator."""
        class SimpleUnitaryOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_config_instantiation(self):
        """Test that UnitaryLinearOperator cannot be instantiated from config (abstract class)."""
        cfg = compose(config_name="linear_operator/unitary.yaml")
        with pytest.raises(Exception, match="Can't instantiate abstract class"):
            instantiate(cfg.linear_operator)
    
    def test_inheritance(self):
        """Test that UnitaryLinearOperator inherits correctly."""
        from gmi.linear_operator.base import LinearOperator
        ...
        class ConcreteUnitaryOperator(UnitaryLinearOperator):
            def __init__(self):
                super().__init__()
