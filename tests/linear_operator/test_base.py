"""
Tests for the base LinearOperator class.
"""
import pytest
import torch
...
class TestLinearOperator:
    """Test cases for the base LinearOperator class."""
    
    def test_abstract_class_instantiation(self):
        """Test that LinearOperator cannot be instantiated directly (abstract class)."""
    ...
    #     class SimpleOperator(LinearOperator):
    #         def __init__(self):
    #             super().__init__()
    #         
    #         def forward(self, x: torch.Tensor) -> torch.Tensor:
    ...
    def test_matmul_operator(self):
        ...
        assert isinstance(composite, CompositeLinearOperator)
    ...
    def test_config_instantiation(self):
        """Test that LinearOperator cannot be instantiated from config (abstract class)."""
        cfg = compose(config_name="linear_operator/base.yaml")
