"""
Tests for the SymmetricLinearOperator class.
"""
import pytest
import torch
...
class TestSymmetricLinearOperator:
    """Test cases for the SymmetricLinearOperator class."""
    
    def test_abstract_class_instantiation(self):
        """Test that SymmetricLinearOperator cannot be instantiated directly (abstract class)."""
    ...
    def test_concrete_symmetric_operator(self, sample_vector_2, sample_matrix_2x2):
        ...
        class SymmetricOperator(SymmetricLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_non_symmetric_matrix(self, sample_vector_2):
        ...
        class NonSymmetricOperator(SymmetricLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_inheritance(self, sample_vector_2):
        """Test that SymmetricLinearOperator inherits from LinearOperator and SquareLinearOperator."""
        from gmi.linear_operator.base import LinearOperator
        from gmi.linear_operator.square import SquareLinearOperator
        class SimpleSymmetricOperator(SymmetricLinearOperator):
            def __init__(self):
                super().__init__()
            def forward(self, x: torch.Tensor) -> torch.Tensor:
                return 2.0 * x
    ...
    def test_transpose_LinearOperator(self, sample_vector_2):
        """Test that transpose_LinearOperator returns self for symmetric operators."""
        class SimpleSymmetricOperator(SymmetricLinearOperator):
            def __init__(self):
                super().__init__()
            def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        assert transpose_op is op, "Symmetric operator: transpose_LinearOperator should return self"
    ...
    def test_config_instantiation(self):
        """Test that SymmetricLinearOperator cannot be instantiated from config (abstract class)."""
        cfg = compose(config_name="linear_operator/symmetric.yaml")
