"""
Tests for the RealLinearOperator class.
"""
import pytest
import torch
...
class TestRealLinearOperator:
    """Test cases for the RealLinearOperator class."""
    
    def test_abstract_class_instantiation(self):
        """Test that RealLinearOperator cannot be instantiated directly (abstract class)."""
        with pytest.raises(TypeError, match="Can't instantiate abstract class"):
            RealLinearOperator()
    
    def test_concrete_subclass_implementation(self, sample_vector_2):
        """Test that a concrete subclass works correctly."""
        class DoubleOperator(RealLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_conjugate_equals_forward(self, sample_vector_2):
        ...
        class ScaleOperator(RealLinearOperator):
    ...
    def test_real_operator_properties(self, sample_vector_2):
        ...
        class IdentityOperator(RealLinearOperator):
            def __init__(self):
                super().__init__()
    ...
    def test_complex_input_handling(self, sample_complex_tensor):
        ...
        class RealScaleOperator(RealLinearOperator):
    ...
    def test_config_instantiation(self):
        """Test that RealLinearOperator cannot be instantiated from config (abstract class)."""
        cfg = compose(config_name="linear_operator/real.yaml")
